...
svn co https://github.com/godros/openwrt-luci-app/trunk/luci-app-uugamebooster package/diy/luci-app-uugamebooster
svn co https://github.com/godros/openwrt-luci-app/trunk/luci-app-ttnode package/diy/luci-app-ttnode
